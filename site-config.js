// Contato e localização: alterar apenas aqui; script.js atualiza todas as ocorrências.
window.SITE_CONFIG = Object.freeze({
  ...
  videos: {
    helena: { src: '', poster: '', captions: '', transcript: '', title: 'Helena explica a Terapia Bowen' },
    cliente1: { src: '', poster: '', captions: '', transcript: '', title: 'Depoimento de cliente — 1' },
    cliente2: { src: '', poster: '', captions: '', transcript: '', title: 'Depoimento de cliente — 2' }
  }
});
